...
void TSet:: CheckElem (const int Elem) const
{
...
int TSet::IsMember(const int Elem) const // элемент множества? ("да" -возвращает положительное число)
{
	CheckElem(Elem);
